...
- **worktree**: git worktree name or main repo name
- **PR**: PR reference (e.g., `PR#42`) or `none`
- **plan-doc**: plan filename or `ad-hoc` if no plan
- **topic**: area of work
- **phase**: from planning doc section/step, or blank if ad-hoc
- **task**: brief description

Examples:
- `my-feature | PR#42 | plan.md | CI setup | Phase 2 | Add lint workflow`
- `main | none | ad-hoc | skills | | Create new skill`
